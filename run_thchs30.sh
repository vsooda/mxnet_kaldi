...
# alignment folder
ali_src=/home/sooda/speech/kaldi/egs/thchs30/s5/exp/tri4b_ali

# decoding graph
graph_src=/home/sooda/speech/kaldi/egs/thchs30/s5/exp/tri4b/graph_phone

# features
train_src=/home/sooda/speech/kaldi/egs/thchs30/s5/data/mfcc/train
...
if [ $stage -le 1 ] ; then
    ...
    #[ ! -e ${train_src}_tr90 ] &&
    echo "utils/subset_data_dir_tr_cv.sh $train_src ${train_src}_tr90 ${train_src}_cv10"
